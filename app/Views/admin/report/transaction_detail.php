    ...
    <form action="<?= base_url('admin/report/sales-detail') ?>" method="GET">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <select name="kdstore"
                    ...
                    <?php foreach ($outlets as $outlet): ?>
                        <option value="<?= esc($outlet['KdStore']) ?>"
                            <?= isset($filters['kdStore']) && $filters['kdStore'] == $outlet['KdStore'] ? 'selected' : '' ?>>
            ...
            <div>
                ...
                <input type="text" name="kasir" value="<?= esc($filters['kasir'] ?? '') ?>" placeholder="Nama kasir..."
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
            </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3">
                                    <div class="text-sm font-medium text-gray-900">
                                        <?= esc($trans['nama_outlet'] ?? 'Outlet ' . $trans['KdStore']) ?>
                                    </div>
